...
Language models offer computational efficiency but are highly susceptible to hallucinations, leading to significant concerns in security and privacy. This research evaluates eight mitigation strategies on small language models using the TruthfulQA benchmark. The experiments measure factual accuracy and semantic consistency, aiming to find out the most efficient hallucination prevention strategies. It is found that contrastive decoding is the most effective defense through an improvement in single-true accuracy from 0.49 to 0.56 compared to the baseline model. Alongside performance comparison across methods, the results demonstrate the effectiveness of different strategies on enhancing the trustworthiness of resource-constrained models. 
